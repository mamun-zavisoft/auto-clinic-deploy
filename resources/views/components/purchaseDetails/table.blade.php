@foreach ($entity as $purchaseDetails)
    ...
    <table class="table  datanew">
        ...
        <tbody class="sales-list">
            ...
            <tr>
                ...
                <td>
                    <span class="badge rounded-pill bg-outline-{{ $purchasesDetail->purchase->status == 'received' ? 'success' : 'warning' }}">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between mb-1">
                                                        <span>Reference:</span>
                                                        <span class="font-weight-bold">{{ $purchasesDetail->purchase->reference_no }}</span>
                                                    </div>
                                                    <div class="d-flex justify-content-between mb-1">
                                                        <span>Payment Status:</span>
                                                        <span class="text-success font-weight-bold">{{ $purchasesDetail->purchase->paid_status }}</span>
                                                    </div>
                                                    <div class="d-flex justify-content-between">
                                                        <span>Status:</span>
                                                        <span class="text-success font-weight-bold">{{ $purchasesDetail->purchase->status }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
