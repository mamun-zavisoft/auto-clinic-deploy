...
<div class="page-wrapper">
    <div class="content">
        <x-breadcrumb-modal title="Vehicle Details" />
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="col-md-4">
                        <div class="card h-100">
                            <div class="card-header bg-info text-white">
                                <h5 class="card-title fw-bold mb-0">Vehicle Information</h5>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="info-item mb-2">
                                    <label class="fw-bold">Owner Type:</label>
                                    <span>{{ $vehicle->owner_type == 1 ? 'Self' : 'External' }}</span>
                                </div>
                                <div class="info-item mb-2">
                                    <label class="fw-bold">Status:</label>
                                    <span class="badge rounded-pill bg-outline-{{ $vehicle->status == 1 ? 'success' : 'warning' }}">
                                        {{ $vehicle->status == 1 ? 'Active' : 'In Service' }}
                                    </span>
                                </div>
                                <div class="info-item mb-2">
                                    <label class="fw-bold">Zone:</label>
                                    <span>{{ $vehicle->zone?->name }}</span>
                                </div>
                                <div class="info-item">
                    ...
                    <div class="col-md-4">
                        <div class="card h-100">
                            <div class="card-header bg-success text-white">
                                <h5 class="card-title fw-bold mb-0">Service History</h5>
                            </div>
                            <div class="card-body">
                                <div class="info-item mb-2">
                                    <label class="fw-bold">Total Services:</label>
                                    <span>{{ $services->count() }}</span>
                                </div>
                                <div class="info-item mb-2">
                                    <label class="fw-bold">Last Service Date:</label>
                                    <span>{{ $services->last()?->created_at?->format('d M Y') ?? 'N/A' }}</span>
                                </div>
                                <div class="info-item">
                                    <label class="fw-bold">Parts Used:</label>
                                    <span class="badge rounded-pill bg-outline-{{ $services->where('any_parts_purchase', true)->count() > 0 ? 'success' : 'warning' }}">
                                        {{ $services->where('any_parts_purchase', true)->count() > 0 ? 'Yes' : 'No' }}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100">
                            <div class="card-header bg-warning text-white"> 
                                <h5 class="card-title fw-bold mb-0">Parts Use</h5>
                            </div>
                            <div class="card-body">
                                <div class="info-item mb-2">
                                    <label class="fw-bold">Total Parts Used:</label>
                                    <span>{{ $services->where('any_parts_purchase', true)->count() }}</span>
                                </div>
                                <div class="info-item mb-2">
                                    <label class="fw-bold">Last Part Used:</label>
                                    <span>{{ $services->where('any_parts_purchase', true)->last()?->created_at?->format('d M Y') ?? 'N/A' }}</span>
                                </div>
                                <div class="info-item">
                                    <label class="fw-bold">Parts Status:</label>
                                    <span class="badge rounded-pill bg-outline-{{ $services->where('any_parts_purchase', true)->count() > 0 ? 'success' : 'warning' }}">
                                        {{ $services->where('any_parts_purchase', true)->count() > 0 ? 'Parts Used' : 'No Parts Used' }}
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Main Card for Service History Table -->
                <div class="card">
                    <div class="card-body">
                        <div class="service-history mb-5">
